    ...
    features: [
      {
        ...
        detail:
          'Empowers the Player 2 support team with advanced filtering and sorting capabilities for efficient ticket management',
      },
      {
        title: 'Dynamic Reporting System',
        detail:
          'Provides in-depth insights into helpdesk performance using a range of data visualizations',
      },
      {
        title: 'Real-time Communication',
        detail:
          'Facilitates seamless chats and notifications, enabling instant interactions between users and support',
      },
    ],
    responsibilities: [
    ...
    features: [
      {
        ...
        detail:
          'Offers a robust room management system, enabling users to create, join, and leave rooms with ease, while also supporting public and private room configurations',
      },
      {
        title: 'Real-Time Interactivity',
        detail:
          'Facilitates real-time chat and lobby updates, dynamically reflecting player activity and room information',
      },
      {
        title: 'Mature Gameplay Mechanism',
        detail:
          'Ensures a well-structured game loop for seamless turn-taking logic and a scoring mechanism based on correct guesses in every Draw and Guess game session',
      },
      {
        title: 'Synchronized Canvas Broadcasting',
        detail:
          'Provides a dynamic whiteboard component with various colors and brush sizes, while broadcasting the drawing in real-time to all players in the room',
      },
    ],
    responsibilities: [
